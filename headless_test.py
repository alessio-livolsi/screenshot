...
for index, url in enumerate(response["results"]):
    ...
    chrome_options.add_argument('window-size=1920x3840')
    ...
    stitch_images(websitePath=browserFilename, windowPath=desktopFilename, targetPath=f"{name}-screenshot.png")
